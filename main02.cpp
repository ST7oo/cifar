...
void
read_batch1(string filename, vector<Mat> &vec, Mat &label){
...
Mat
concatenateMat1(vector<Mat> &vec){
...
Mat
concatenateMatC1(vector<Mat> &vec){
...
main1()
{
    ...
    read_CIFAR101(trainX, testX, trainY, testY);
    waitKey();
    return 0;
}
